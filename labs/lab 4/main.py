...
def main():
    ...
    if len_roots == 0:
        ...
        print('Один корень: {:.4f}'.format(roots[0]))
    elif len_roots == 2:
        print('Два корня: {:.4f} и {:.4f}'.format(roots[0], roots[1]))
    elif len_roots == 3:
        print('Четыре корня: {:.4f}, {:.4f} и {:.4f}'.format(roots[0], roots[1], roots[2]))
    elif len_roots == 4:
        print('Четыре корня: {:.4f}, {:.4f}, {:.4f} и {:.4f}'.format(roots[0], roots[1], roots[2], roots[3]))
    elif len_roots == 5:
